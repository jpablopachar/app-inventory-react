...
/**
 * Contenedor estilizado para el componente Lineal.
 *
 * Este componente utiliza estilos personalizados con styled-components para crear
 * un contenedor flexible que organiza el gráfico de línea y la lista de datos en
 * una disposición horizontal o vertical dependiendo del espacio disponible.
 *
 * @component
 */
export const LinealContainer = styled.div`
  display: flex;
  flex-wrap: wrap;
...
/**
 * Contenedor estilizado para cada tarjeta de datos dentro del componente Lineal.
 *
 ...
 * @component
 */
export const LinealContentCards = styled.div`
  display: flex;
