 ...
 * 
 * @component
 * @param {TablesStylesProps} props - Propiedades para
 * personalizar el color de las categorías y el tema.
 */
export const TableContainer = styled.div<TablesStylesProps>`
  position: relative;
  margin: 5% 3%;
 ...
 */
interface TablesColorContentProps {
  color: string
}
 ...
 */
export const TableColorContent = styled.div<TablesColorContentProps>`
  color: ${(props) => props.color};
  border-radius: 8px;
