...
interface BrandsTableStylesProps {
  theme: {
    text: string
  }
}

export const BrandsTableContainer = styled.div<BrandsTableStylesProps>`
  position: relative;
  margin: 5% 3%;
...
export const colorContent = styled.div<ColorContentProps>`
  justify-content: center;
