 ...
 * @property theme.colorSubtitleCard Color del subtítulo en las tarjetas.
 * @property theme.colorTitleCard Color del título en las tarjetas.
 * @property theme.bg5 Color de fondo adicional utilizado en el tema.
 */
interface ConfigurationTemplateStylesProps {
  theme: {
    bgTotal: string
    bgCards: string
...
export const ConfigurationTemplateContainer = styled.div<ConfigurationTemplateStylesProps>`
